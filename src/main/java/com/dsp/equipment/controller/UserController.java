...
import com.dsp.equipment.services.LogServiceImpl;
import com.dsp.equipment.utils.HttpUtil;
import com.github.pagehelper.PageHelper;
import com.github.pagehelper.PageInfo;
import com.dsp.equipment.entity.Result;
import com.dsp.equipment.entity.Role;
import com.dsp.equipment.entity.User;
...
public class UserController {
    ...
    public Result login(User user, HttpServletRequest request) throws IOException {
        ...
        if(resultUser==null){
            ...
            }else if (!resultUser.getRoleId().equals(user.getRoleId())){
                result.setError("该角色下不存在该用户！");
            }else{
    ...
    public Result updatePwd(HttpServletRequest request, HttpServletResponse response)throws Exception{
        ...
        if(!(password.equals(password1))){
            ...
            result.setError("新密码与原密码一致，请重新输入");
        } else{
            resultUser.setPassword(password3);
