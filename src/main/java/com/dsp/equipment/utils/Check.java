package com.dsp.equipment.utils;
...
public class Check {
    ...
    public String check(int width,int height,HttpServletResponse resp) throws IOException {
        ...
        String random = drawRandomNum((Graphics2D) graphics, "nl");
