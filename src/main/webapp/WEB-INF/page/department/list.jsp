	...
	<div class="layui-search">
		<form class="layui-form">
			<div class="layui-form-item">
				...
				<button type="button" class="layui-btn layui-btn-normal btnAdd">+ 新增部门</button>
			</div>
		</form>
	</div>
...
layui.use('table', function(){
	...
	table.on('tool(demo)', function(obj){
		var data = obj.data;
		if(obj.event === 'del'){
			layer.confirm('部门编号：'+data.id+'<br />部门名称：'+data.name, {icon: 3, title:'是否确定删除?'}, function(index){
				$.ajax({
