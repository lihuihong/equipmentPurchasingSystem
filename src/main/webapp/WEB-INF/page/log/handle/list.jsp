    ...
    layui.use(['table','laydate'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                {field:'opModule',width:'10%', title: '操作模块', align:'center'},
                {field:'opMethod', title: '具体操作路径', align:'center'},
                {field:'opType',width:'10%',  title: '操作类型', align:'center',templet:function (d) {
                        switch (d.opType) {
                            case 1:
                                return '新增';
                            case 2:
                ...
                {field:'opContent', title: '操作内容', align:'center'},
                {field:'addTime',width:'15%', title: '时间', align:'center'},
            ]],
            page: true
        });
        //重载表格
